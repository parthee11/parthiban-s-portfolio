        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1 text-center md:text-left animate-fade-in">
            ...
            <p className="text-lg md:text-xl text-gray-700 mb-8 max-w-2xl">
              A passionate Software Engineer specializing in frontend development. With expertise in React, Next.js, and TypeScript, I design high-performance, user-friendly applications. Let's connect and create something amazing together.
            </p>
            ...
            <div className="flex gap-4 mt-8 justify-center md:justify-start">
              ...
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-primary transition-colors">
